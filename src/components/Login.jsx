    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white border border-gray-300 rounded-2xl shadow-sm p-8">
        ...
        <div className="space-y-3 mb-8">
          {/* Google */}
          <button className="w-full flex items-center justify-center gap-3 py-4 border border-gray-300 rounded-xl hover:bg-gray-50 hover:ring-2 hover:ring-gray-300 transition-all bg-white focus:outline-none">
